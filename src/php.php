...
`<?php e(($argument->isByReference ? '&' : '') . ($argument->isVariadic ? '…' : '') . '$' . $argument->name); ?>`|<?php e(linkOwn($targetFile, '`' . $argument->type . '`')); ?>|<?php e($argument->default ? '`' . $argument->default . '`' : ''); ?>|<?php e($argument->description); ?>
